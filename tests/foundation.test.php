...
gt_assert_equal( false, has_action( 'woocommerce_before_shop_loop_item', 'woocommerce_template_loop_product_link_open' ), 'card link-open hook removed (theme wraps the card in its own <a>)' );
gt_assert_equal( false, has_action( 'woocommerce_after_shop_loop_item', 'woocommerce_template_loop_product_link_close' ), 'card link-close hook removed' );
gt_assert_equal( false, has_action( 'woocommerce_after_shop_loop_item_title', 'woocommerce_template_loop_rating' ), 'loop rating hook removed' );
gt_assert_equal( false, has_action( 'woocommerce_before_shop_loop_item_title', 'woocommerce_show_product_loop_sale_flash' ), 'sale flash hook removed' );
gt_assert_equal( false, has_action( 'woocommerce_before_shop_loop_item_title', 'woocommerce_template_loop_product_thumbnail' ), 'default thumbnail hook removed (theme renders its own)' );
gt_assert_equal( false, has_action( 'woocommerce_shop_loop_item_title', 'woocommerce_template_loop_product_title' ), 'default title hook removed (theme renders its own)' );
